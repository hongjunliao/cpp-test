...
{
  __tfork (loc, _mkevent (c, loc, NULL, rv, w1), r1, a);
}
...
{
  __tfork (loc, _mkevent (c, loc, NULL, rv, w1, w2), a);
}
...
{
  __tfork (loc, _mkevent (c, loc, NULL, rv, w1, w2), r1, a);
}
...
{
  __tfork (loc, _mkevent (c, loc, NULL, rv, w1, w2, w3), a);
}
...
{
  __tfork (loc, _mkevent (c, loc, NULL, rv, w1, w2, w3), r1, a);
}
